...
class Court1v1():
    ...
    def Check3ptShotvsRebound(self):
    ...
    def PlayGame(self):
        ...
        while (self.score1 or self.score2 <= 11):
            Court1v1.ShotActionandName(self)
            if ((ShootAction == '3 pointer') or (ShootAction == 'midrange') or (ShootAction == 'layup')):
                Court1v1.Roll3PointShot(self)
                Court1v1.DefenseActionandName(self)
                Court1v1.DefenseActionandName(self)
                Court1v1.Check3ptShotvsBlock(self)
                Court1v1.Check3ptShotvsRebound(self)
            else:
