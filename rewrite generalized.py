...
class Court1v1():
    ...
    def PlayGame(self):
        ...
        while (self.score1 or self.score2 <= 11):
            ...
            if (Action == 'shoot'):
                print(self.CurrentPlayerLocation)
            ...
            if (Action == 'defend'):
                if(self.PlayerLastMove == 'shot'):
                    ...
                    if(DefenseAction == 'block'):
                        if((self.OtherPlayerLocation['x'] == 3) and (self.OtherPlayerLocation['y'] >= 3)):
                        ...
                        print('Yous sagged off to go rebound!')
                        self.CurrentPlayerLocation = {'x': 3, 'y': 5}
                    elif (DefenseAction == 'block'):
                        print('block')

                    print('bruh 2')

                if(self.PlayerLastMove == 'layup'):
                    if (((self.CurrentPlayerLocation['x'] + 1) or (self.CurrentPlayerLocation['x'] - 1) ==
                         self.OtherPlayerLocation['x']) and (self.CurrentPlayerLocation['y'] + 1) or (
                            self.CurrentPlayerLocation['y'] - 1) == self.OtherPlayerLocation['y']):
                        DefenseAction = input('Would you like to attempt a block?').lower()
                    if(DefenseAction == 'block'):
                        if((self.OtherPlayerLocation['x'] == 3) and (self.OtherPlayerLocation['y'] == 3 or 4 or 5)):
                            BlockRoll = Court1v1.RollInsideBlock(self)
                        else:
                            BlockRoll = Court1v1.RollOutsideBlock(self)
                    elif(DefenseAction == 'rebound'):
